...
kin_group = t_env.getKinematicGroup("manipulator")
print("kin group:", kin_group)
...
wp1 = CartesianWaypoint(Isometry3d.Identity() * Translation3d(0.5,-0.3,1.455) * Quaterniond(0.70710678,0,0.70710678,0))
